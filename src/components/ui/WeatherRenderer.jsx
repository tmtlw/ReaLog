...
export const getWeatherCategory = (data?) => {
...
const WeatherRenderer = ({ data, pack = 'outline', className = "w-5 h-5" }) => {
    ...
    if (pack === 'neon') {
        ...
        const glow = (col) => `${className} ${col} drop-shadow-[0_0_3px_currentColor] filter`;
        switch(category) {
