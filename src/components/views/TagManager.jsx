...
const TagManager = ({ entries, onUpdateEntries, onBack, onSelectTag, themeClasses, t, isAdmin }) => {
                                ...
                                <>
                                    <div className="flex items-center gap-2">
                                        <span
                                            ...
                                            style={{
                                                backgroundColorToBgColor(tag, themeClasses.bg.includes('black') || themeClasses.bg.includes('9') ? 'dark' : 'light'),
                                                colorToColor(tag, themeClasses.bg.includes('black') || themeClasses.bg.includes('9') ? 'dark' : 'light')
                                            }}
                                        >
                                            #{tag}
                                        </span>
