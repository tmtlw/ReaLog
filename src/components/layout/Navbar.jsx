...
import {
  Map, Images, Download, Server, Settings, LogOut, Lock, Menu, Hash, CalendarClock, Palette, Monitor, MoreVertical, Trash2, PieChart, Trophy, Upload, Book, Dices
} from 'lucide-react';
...
const Navbar = ({
    ...
    const getCategoryButtonClass = (cat, isActive) => {
    ...
    return (
        <nav className={`sticky top-0 z-50 backdrop-blur-md border-b transition-colors ${themeClasses.nav}`}>
            <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
                ...
                {/* Right Side Icons & Auth / Mobile Menu Toggle */}
