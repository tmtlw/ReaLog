...
const EntryList = ({
    ...
    const habits = StorageService.loadData().habits || [];

    const getCatLabel = (cat) => t(`category.${cat.toLowerCase()}`);
        ...
        return (
            <div className="flex flex-wrap gap-1 mt-2">
                {activeHabitIds.map((id) => {
                    ...
                    // Icon logic habitDef icon if available, else default
                    ...
                    return (
                        <div key={e.id} className="relative pl-8 group">
                            ...
                            <div className={`mt-2 ${showDateHeader ? 'pt-6' : ''}`}>
                                ...
                                <div
                                    className={`p-4 rounded-lg border transition-all cursor-pointer ${themeClasses.card} ${e.isDraft ? 'border-dashed border-orange-500/50' [e.category] || 'hover:border-emerald-500/50'}`}
