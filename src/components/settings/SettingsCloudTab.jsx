...
import { Layout, ArrowUp, ArrowDown, Map } from 'lucide-react';
...
const SettingsLayoutTab = ({ localSettings, setLocalSettings, themeClasses, t = (k)=>k }) => {
    ...
    const moveItem = (index, direction: 'up' | 'down') => {
