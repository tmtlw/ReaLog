...
const EMOJI_STYLES<string, React.CSSProperties> = {
    'noto': {
...
export const getEmojiStyleObject = (style).CSSProperties => {
...
const EmojiRenderer = ({ emoji, style = 'native', className = "", onClick }) => {
    ...
    if (['openmoji', 'emojidex', 'noto', 'noto-mono'].includes(style)) {
        ...
        // Note removes !important from inline styles.
