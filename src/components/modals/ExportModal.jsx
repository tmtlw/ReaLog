                        ...
                        {range === 'custom' && (
                            <div className="grid grid-cols-2 gap-2 mb-4">
                                <div>
                                    ...
                                    <Input themeClasses={themeClasses} type="date" value={startDate} onChange={(e) => setStartDate(e.target.value)} />
                                </div>
                                <div>
                                    <span className={`text-xs block mb-1 ${themeClasses.subtext}`}>{t('export.end')}</span>
                                    <Input themeClasses={themeClasses} type="date" value={endDate} onChange={(e) => setEndDate(e.target.value)} />
                                </div>
                            </div>
                        )}
