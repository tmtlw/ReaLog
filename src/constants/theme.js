...
export const generateCustomTheme = (base: 'light' | 'dark', accentKey: keyof typeof ACCENT_COLORS, customBg?) => {
...
const checkDate = (d, month, day) => d.getMonth() === month - 1 && d.getDate() === day;

// Checks if date is the Nth Weekday of Month (e.g., 2nd Sunday of May)
// nth: 1=1st, 2=2nd, -1=Last
// weekday: 0=Sun, 1=Mon...
const checkNthDay = (d, month, weekday, nth) => {
...
const MOVABLE_DATES<string, string[]> = {
    chinese_new_year: [
...
const getNthDayDisplayDate = (year, month, weekday, nth) => {
...
const checkHanukkah = (d) => checkMovable(d, 'hanukkah');

// Easter exception and Monday (multi-day)
const checkEaster = (d) => {
    // Check Sunday
...
export const HOLIDAY_THEMES = [
    ...
    },
    {
        ...
        name: 'Gyereknap',
        emoji: '🎈',
        match: (d) => checkNthDay(d, 5, 0, -1), // HU Sunday of May
        getDisplayDate: (y) => getNthDayDisplayDate(y, 5, 0, -1),
        colors: {
            bg: 'bg-cyan-50',
            text: 'text-blue-900',
...
export const getHolidayTheme = (date) | null => {
