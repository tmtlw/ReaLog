...
import { Bold, Italic, Underline, List, Link, Heading1, Quote, Code, RotateCcw, Clock } from 'lucide-react';



const RichTextEditor = ({ value, onChange, themeClasses, placeholder, minHeight = "200px", fontSize = "100%" }) => {
    ...
    const ToolbarButton = ({ icon, cmd, arg, title, onClick }) => (
        <button
            type="button"
            onClick={(e) => {
                e.preventDefault();
