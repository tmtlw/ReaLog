...
const SettingsViewsTab = ({ localSettings, setLocalSettings, themeClasses, t }) => {

    const updateCategoryConfig = (cat, key, value) => {
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <input
                            ...
                            onChange={(e) => setLocalSettings(prev => ({ ...prev, minWordCount: parseInt(e.target.value) || 0 }))}
                        />
                    </div>
                </div>
            </div>
