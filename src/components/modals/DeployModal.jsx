...
const DeployModal void, themeClasses, t: (key) => string }> = ({ onClose, themeClasses, t }) => {
    const [isZipping, setIsZipping] = useState(false);
    const [activeTab, setActiveTab] = useState('install');
    const [serverType, setServerType] = useState('php');
    ...
    const handleDownloadSource = async () => {
        ...
        try {
            ...
            zip.file('.htaccess', serverType === 'php' ? SERVER_CODE_HTACCESS_PHP );
